...
"""
CREATE_DISLIKE_FORM_TABLE_QUERY = """
        CREATE TABLE IF NOT EXISTS like_form
        (ID INTEGER PRIMARY KEY,
        OWNER_TELEGRAM_ID INTEGER,
        LIKER_TELEGRAM_ID INTEGER
...
CREATE_FAVOURITE_FILMS_TABLE_QUERY = """
...
INSERT_DISLIKE_FORM_QUERY = """INSERT OR IGNORE INTO dislike_form VALUES (?,?,?)"""

SELECT_DISLIKE_FORM_QUERY = """
SELECT * FROM like_form WHERE OWNER_TELEGRAM_ID = ? AND DISLIKER_TELEGRAM_ID = ?
"""

INSERT_FILMS_QUERY = """INSERT OR IGNORE INTO films VALUES (?,?)"""

SELECT_SPECIFIC_FILMS_QUERY = """
SELECT * FROM films WHERE LINK = ?"""

INSERT_FAVOURITE_FILMS_QUERY = """INSERT OR IGNORE INTO favourite_films VALUES (?,?,?)"""

SELECT_OWNER_FILMS_QUERY = """
SELECT LINK FROM favourite_films WHERE OWNER_TELEGRAM_ID = ?"""

SELECT_SPECIFIC_FILMS_FOR_FAVOURITE_QUERY = """
SELECT LINK FROM films WHERE ID = ?"""
